...
int i=0;
 while(rs.next())
 {
     ...
     out.println("<tr>");
     out.println("<td><a href=del3.jsp?id="+id+">Delete</a></td><td>"+id+"</td><td>"+type+"</td><td>"+subtype+"</td><td>"+name+"</td><td>"+halfprice+"</td><td>"+fullprice+"</td><td><img src='../images/"+image+"' width=100 height=100></td>");
     out.println("</tr>");
