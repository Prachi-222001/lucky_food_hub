...
try
{
	...
	Connection cn=DriverManager.getConnection("jdbc:mysql://localhost:3306/luckydb","root","");
            ...
            String sql="select * from product where type='Veg' and subtype='Starter'";
...
int i=0;
 while(rs.next())
 {
     ...
     out.println("<b>"+name+"</b><br><b>"+fp+" / "+hp+"</b><br></div></a><a class=\"btn btn-primary\" href=buy.jsp?cakeid="+id+"&fprice="+fp+"&hprice="+hp+"&username="+unm+">Buy Now</a> <a class=\"btn btn-primary\" href=addtocart.jsp?cakeid="+id+"&fprice="+fp+"hprice="+hp+"&username="+unm+"> Add To Cart</a></div></div>");
	 i++;
if(i==3)
{
out.println("</div>");
...
out.println("<div class=\"row\" align=center>");
	        ...
	        String sql2="select * from product where type='Veg' and subtype='Rice'";
...
out.println("<div class=\"row\" align=center>");
            ...
            String sql1="select * from product where type='Veg' and subtype='Noodles'";
