...
<?php
$rs=mysqli_query($cn,"select * from foodmenu where type='nonvegstarter'");
...
<select name="i2" id="i2" style="height:30px" class="clr">
  ...
  <option value="#">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;------Select------&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
<?php
$rs=mysqli_query($cn,"select * from foodmenu where type='nonvegbhaji'");
while($a=mysqli_fetch_array($rs))
{
extract($a);
echo"<option value='$name'>&nbsp;$name&nbsp;</option>";
...
$perperson=$price1+$price2+$price3+$price4+$price5;
$total=$perperson*$totalperson;

echo"Selected Menu:<br> $i1 ,$i2 ,$i3 ,$i4 ,$i5 ";
...
$i4=$_SESSION['ni4'];
$i5=$_SESSION['ni5'];
$totalvegprice=$_SESSION['tfoodprice'];
$totalnonvegprice=$_SESSION['tfoodpricenvg'];
$total=$totalnonvegprice+$totalvegprice;
include("connection.php");
$q1="update booking set foodnvg='$i1 ,$i2, $i3 ,$i4 ,$i5'  where phoneno='$phoneno' and bookingid='$bookingid'";
mysqli_query($cn,$q1);
$q="update foodmenuorder set nonveg1='$i1',nonveg2='$i2',nonveg3='$i3',nonveg4='$i4',nonveg5='$i5',nonvegtotal='$totalnonvegprice',totalprice='$total'";
mysqli_query($cn,$q);
mysqli_close($cn);
echo"<script>window.location='cake3.php'</script>";
}
?>