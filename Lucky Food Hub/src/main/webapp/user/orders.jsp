...
try
{
	...
	Connection cn=DriverManager.getConnection("jdbc:mysql://localhost:3306/luckydb","root","");
            ...
            String sql="select * from payment where username='smita'"; 
...
int i=0;
 while(rs.next())
 {
     ...
     String mode,am,num,add,products,date1,orderid;
     ...
     out.println("<tr>");
     out.println("<td>"+date1+"</td><td>"+orderid+"</td><td>"+unm+"</td><td>"+mode+"</td><td>"+am+"</td><td>"+num+"</td><td>"+add+"</td><td>"+products+"</td>");
     out.println("</tr>");
